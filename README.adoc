...
https://www.jaegertracing.io/docs/1.17/getting-started/#all-in-one[Jaeger documentation^].
...
[source, Java, linenums, role='code_column hide_tags=copyright,Add tags=addToInvList']
----
